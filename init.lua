...
require('lazy').setup({
  ...
  -- Local Plugins
  {
    dir='/Users/sn/Dev/lua/nvim-plugins/test-plugin'
  },
  {
    dir='/Users/sn/Dev/lua/nvim-plugins/test-text-plugin',
    config= function ()
      local sb = require('scratch-buffer')
      sb.setup()
    end
  },
...
--
-- lua rocks config -- hold off on using this I beleive in lazy nvim
    local rocks_config = {
